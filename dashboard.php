...
<div class="sidebar sidebar-narrow-unfoldable border-end">
  ...
  <div class="clearfix">
            <a href="add_buku.php" class="btn btn-primary float-end" style="width: 100px; margin-right: 50px;">Add</a>
        </div>
        <?php
                ...
                while ($data = mysqli_fetch_assoc($result)) {
                  $harga = number_format($data['harga'], 2, ',','.');
                    ...
                    echo "<td class=\"text-center\">
                            <form action=\"./update_buku.php\" method=\"post\" class=\"d-inline-block mb-2\">
                                <input type=\"hidden\" name=\"id\" value=\"{$data['id']}\">
                                <input type=\"submit\" name=\"submit\" value=\"Update\" style=\"width: 80px\" class=\"btn btn-info text-white\">
                            </form>
                            <form action=\"./delete_buku.php\" method=\"post\" class=\"d-inline-block\">
                                <input type=\"hidden\" name=\"id\" value=\"{$data['id']}\">
