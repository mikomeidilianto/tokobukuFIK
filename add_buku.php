...
if (isset($_POST["submit"])) {
    ...
    if ($error_message === "") {
        ...
        $query = "INSERT INTO buku (judul_buku, foto, ISBN, tahun_terbit, harga, stok_buku, publisher, author) 
              VALUES ('$judul_buku', '$foto', '$ISBN', '$tahun_terbit', '$harga', '$stok_buku', '$publisher', '$author')";
        $result = mysqli_query($link, $query);

        if ($result) {
            $message = "Buku dengan nama \"<b>$judul_buku</b>\" sudah berhasil ditambahkan";
